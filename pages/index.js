...
import whitelistedChains from '../stores/constants/whitelist';
        ...
        <div className={theme.palette.type === 'dark' ? classes.containerDark : classes.container}>
          <div className={classes.copyContainer}>
            <div className={classes.copyCentered}>
              <Typography variant='h1' className={classes.chainListSpacing}><span className={classes.helpingUnderline}><a href="https://www.sgcrypto.info/">Sg Crypto Information</a></span></Typography>
              <Typography variant='h2' className={classes.helpingParagraph}>Filterd down chain list for the most common coins.</Typography>
              <Typography className={classes.subTitle}>Full credits to chainlist.org for original site</Typography>
              <br />
              <Typography className={classes.subTitle}>Original website: <a href="https://chainlist.org" style={{ color: 'lightblue' }}>https://chainlist.org</a></Typography>
              <Typography className={classes.subTitle}>Chaininfo Oracle: <a href="https://chainid.network" style={{ color: 'lightblue' }}>https://chainid.network</a></Typography>
              {/* <Button
                size='large'
                color='primary'
                variant='contained'
